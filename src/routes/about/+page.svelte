...
<section class="mb-16">
	...
	<h1 class="text-4xl md:text-5xl font-bold leading-tight mt-2 mb-4">{site.name}</h1>
	<p class="font-mono text-sm tracking-wide text-muted-foreground mb-8">{site.location}</p>
